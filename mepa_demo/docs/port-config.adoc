...
"port_config"
        ...
        mepa-cmd phy speed <port_list> [10hdx|10fdx|100hdx|100fdx|1000fdx|10g|25g] [cl37-aneg] [r-fec] [rs-fec] [fec-host|fec-line|fec-h-l]
...
To enable logging, the below command can be used.
	...
	mepa-cmd Phy kr_log enable <port_list> [host] [line]

Example: 
----
mepa-cmd phy kr_log enable 3 host line
----
...
To get ANEG/KR status log below command can be used.
	...
	mepa-cmd Phy kr_log status <port_list> [host] [line] [aneg|eq|ber|irq|all|clr]

Example 1: To get ANEG log
----
mepa-cmd phy kr_log status 3 line aneg
----
...
----
mepa-cmd phy kr_log status 3 line eq
----
...
----
mepa-cmd phy kr_log status 3 line ber
----
...
----
mepa-cmd phy kr_log status 3 line irq
----
...
----
mepa-cmd phy kr_log status 3 line all
----
...
To Reset KR Logging RAM Memory, below command can be used.
	...
	mepa-cmd Phy kr_log status <port_list> [host] [line] clr

Example:
----
mepa-cmd Phy kr_log status 3 host line clr
----

==== Disable KR Logging
To disable logging, the below command can be used.

	mepa-cmd Phy kr_log disable <port_list> [host] [line]

Example:
---- 
	mepa-cmd phy kr_log disable 3,4 host line
----
