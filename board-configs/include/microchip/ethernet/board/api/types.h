...
#define MEBA_EDS2_CAP   \
        (MEBA_PORT_CAP_1G_PHY | MEBA_PORT_CAP_1G_FDX | MEBA_PORT_CAP_FLOW_CTRL | MEBA_PORT_CAP_SFP_1G | \
         ...
         MEBA_PORT_CAP_100M_HDX | MEBA_PORT_CAP_100M_FDX | MEBA_PORT_CAP_TRI_SPEED_COPPER | \
...
typedef struct {
    ...
    mepa_spi_read_t  mepa_spi_slot1_reg_read;
    mepa_spi_write_t mepa_spi_slot1_reg_write;
    mepa_spi_read_t  mepa_spi_slot2_reg_read;
    mepa_spi_write_t mepa_spi_slot2_reg_write;
    mesa_i2c_read_t  i2c_read;
    mesa_i2c_write_t i2c_write;
    meba_conf_get_t  conf_get;
    meba_debug_t     debug;
    mesa_bool_t      phy_attach;
